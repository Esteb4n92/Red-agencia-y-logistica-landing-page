  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 flex items-center justify-between">
        ...
        <a href="#" className="relative h-14 w-48 md:h-16 md:w-52 flex-shrink-0">
...
function ReelSection({ lang }: { lang: Lang }) {
  ...
  const reels = [
    ...
    { src: '/videos/reel-02.mp4', poster: '/fotos/seleccion/foto61.png', title: t.c2t, sub: t.c2s },
  ]
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <div className="flex justify-center">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold rounded-full transition-all duration-300 hover:shadow-[0_0_32px_rgba(37,211,102,0.55)] text-xs w-full sm:w-auto max-w-[200px] mx-auto"
            >
